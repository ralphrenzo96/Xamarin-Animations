...
namespace XamarinAnimation.Views
{
    public partial class AnimationPage : ContentPage
    {
        ...
        public AnimationPage()
        {
            ...
            animationTypes.Add(new AnimationTypeModel { Image = "anim_02", Name = "Scaling", Index = 3, Details = "This code animates the Image instance by scaling up to twice its size over 2 seconds (2000 milliseconds). The ScaleTo method obtains the current Scale property value (default value of 1) for the start of the animation, and then scales from that value to its first argument (2). This has the effect of expanding the size of the image to twice its size." });
            animationTypes.Add(new AnimationTypeModel { Image = "anim_02", Name = "Relative", Index = 4, Details = "This code animates the Image instance by scaling up to twice its size over 2 seconds (2000 milliseconds). The RelScaleTo method obtains the current Scale property value for the start of the animation, and then scales from that value to the value plus its first argument (2). This ensures that each animation will always be a scaling of 2 from the starting position." });
            //animationTypes.Add(new AnimationTypeModel { Image = "anim_02", Name = "Scaling", Index = 3, Details = ""});
